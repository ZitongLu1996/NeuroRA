...
def rdms_corr(demo_rdm, eeg_rdms, method="spearman", rescale=False, permutation=False, iter=5000):
            ...
            for j in range(n2):
                for k in range(n3):
                    ...
                    if method == "spearman":
                        ...
                        corrs[i, j, 0] = rdm_similarity(demo_rdm, eeg_rdms[i, j], rescale=rescale, permutation=permutation, iter=iter)
                    elif method == "distance":
                        corrs[i, j, 0] = rdm_distance(demo_rdm, eeg_rdms[i, j], rescale=rescale, permutation=permutation, iter=iter)
